...

{
  ...
  # DISABLED: macOS periodic and APFS handle this natively
  ...
  # DISABLED: Rarely needed, manual reindex if Spotlight bugs
  ...
  # DISABLED: macOS and APFS handle disk cleanup natively
  ...
  # DISABLED: Nice-to-have but not critical, manual rollback if needed
