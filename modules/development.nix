...

{
  ...
  config = lib.mkMerge [
    # Base development packages (always loaded)
    {
    ...
    # Python development stack (conditional - only evaluated if enabled)
    ...
    # Development environment variables and aliases
    {
      ...
      # Note: EDITOR, VISUAL, PAGER are configured in modules/environment.nix to avoid conflicts
